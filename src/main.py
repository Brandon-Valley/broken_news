...
RUN_DIR_PATH           = os.path.abspath(os.path.join(SCRIPT_PARENT_DIR_PATH, '..', 'run')) # very lazy
...
def main():
    ...
    # script str needed for google imgs
    print('Writing Video from Voice Clip...')
    animation_utils.write_vid_from_voice_clip(VOICE_CLIP_FILE_PATH, fps, script_str, FINAL_VID_PATH, NUM_GOOGLE_IMGS_PER_SEC)
